...
<body>
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_POST['submit'])){
			...
			$sql = mysqli_query($koneksi, "UPDATE mahasiswa SET nama='$nama', jenis_kelamin='$jenis_kelamin', jurusan='$jurusan', fakultas='$fakultas' WHERE id='$id'") or die(mysqli_error($koneksi));
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<select name="jurusan" class="form-control" required>
						...
						<option value="KOMUNIKASI" <?php if($data['fakultas'] == 'KOMUNIKASI'){ echo 'selected'; } ?>>KOMUNIKASI</option>
